...
#### Examples
    ...
    - Example of most recent where I updated main
        - https://github.com/MOvenshire/submod/actions/runs/17310117778
        - https://github.com/MOvenshire/base/commit/bf493efe7488fb2b29769822e3fd305127777930 (note: github-actions committed but no mention of verified or unverified bc not signed)
    


### Misc notes: 
sup is my git alias for submodule update. It was just easier to type the shorthand to get something together quickly.
